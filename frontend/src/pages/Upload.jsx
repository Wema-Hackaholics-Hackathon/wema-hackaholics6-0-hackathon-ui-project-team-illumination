...
const Upload = () => {
  ...
  if (uploadStep === 'success') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0C0517] via-[#1a0b2e] to-[#2d1b69]">
        ...
        <div className="flex flex-col justify-center min-h-[calc(100vh-120px)]">
          <div className="w-full max-w-md mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-3">Document Upload</h1>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/30 backdrop-blur rounded-2xl p-6 border border-gray-700/50">
                <h3 className="text-white font-medium mb-4">Accepted Documents</h3>
              ...
              <div className="space-y-4">
                ...
                {selectedFile && (
                  <div className="bg-gray-800/50 backdrop-blur rounded-xl p-4 border border-gray-700/50 animate-fadeIn">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#A350B6] to-[#8A42A1] hover:from-[#8A42A1] hover:to-[#7A3691] disabled:from-gray-700 disabled:to-gray-800 disabled:cursor-not-allowed text-white font-medium py-4 rounded-xl transition-all duration-200 shadow-lg"
                >
                  {isUploading ? (
